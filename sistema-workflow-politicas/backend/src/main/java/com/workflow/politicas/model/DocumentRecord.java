...
/**
 * Metadatos de un documento digital almacenado en S3 (CU17/CU18).
 */
@Document(collection = "document_records")
public class DocumentRecord {

    public static final String STATUS_ACTIVO = "ACTIVO";
    public static final String STATUS_HISTORICO = "HISTORICO";
    public static final String STATUS_ELIMINADO = "ELIMINADO";
